...
//        //konfig realm, pertama dijaklankan, maka config akan dijalankan.
//        Realm.init(this); //ketika realm database sdh diiintasl, maka ketika di hover akan ad import class
//        RealmConfiguration config = new RealmConfiguration.Builder().allowWritesOnUiThread(true).deleteRealmIfMigrationNeeded().build();
//        //allowWritesOnUiThread kalian tekan sebuha tombol lalu kalian olahdatabase utk insert delete.
        ...
        btninq.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View view) {
                  Intent intent = new Intent(getApplicationContext(), UserInquiry.class);
